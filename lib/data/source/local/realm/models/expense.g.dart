...
class RealmExpense extends _RealmExpense with RealmEntity, RealmObjectBase, RealmObject {
  RealmExpense(
    ObjectId id,
    String name,
    double amount,
  ...
  @override
  DateTime get paidAt => RealmObjectBase.get<DateTime>(this, 'paidAt') as DateTime;
  @override
  ...
  @override
  String? get categoryIconName => RealmObjectBase.get<String>(this, 'categoryIconName') as String?;
  @override
  set categoryIconName(String? value) => RealmObjectBase.set(this, 'categoryIconName', value);

  @override
  Stream<RealmObjectChanges<RealmExpense>> get changes => RealmObjectBase.getChanges<RealmExpense>(this);
  ...
  static SchemaObject _initSchema() {
    ...
    return SchemaObject(ObjectType.realmObject, RealmExpense, 'RealmExpense', [
      ...
      SchemaProperty('categoryIconName', RealmPropertyType.string, optional: true),
    ]);
  }
}
